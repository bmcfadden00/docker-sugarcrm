...
If you already have MySQL installed or want to use a platform service like Amazon RDS, you can run the SugarCRM container separately using Docker run. To set up SugarCRM using this approach, please do the following:
